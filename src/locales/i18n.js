...
export const TRANSLATIONS = {
  ...
  // Unclear / Außerplanmäßig items
  unclearBtn: { de: 'außerplanmäßig verbaut', ro: 'instalat neplanificat', pl: 'zamontowane pozaplanowo', hr: 'ugrađeno izvan plana' },
  unclearBtnShort: { de: 'außerplanmäßig verbaut', ro: 'instalat neplanificat', pl: 'zamontowane pozaplanowo', hr: 'ugrađeno izvan plana' },
  btnNeedMaterialTime: { de: '+ Material/Zeit benötigt', ro: '+ Necesar material/timp', pl: '+ Potrzebny materiał/czas', hr: '+ Potreban materijal/vrijeme' },
  btnUnplannedInstalled: { de: 'außerplanmäßig verbaut', ro: 'instalat neplanificat', pl: 'zamontowane pozaplanowo', hr: 'ugrađeno izvan plana' },
  completeBtnShort: { de: 'Monteur fertig', ro: 'Montator gata', pl: 'Monter gotowy', hr: 'Monter završio' },
  unclearTitle: { de: 'Außerplanmäßig verbaut', ro: 'Instalat neplanificat', pl: 'Montaż pozaplanowy', hr: 'Ugrađeno izvan plana' },
  unplannedBadge: { de: 'Außerplanmäßig', ro: 'Neplanificat', pl: 'Pozaplanowo', hr: 'Izvan plana' },
  unplannedReason: { de: 'Begründung für Einbau', ro: 'Motiv pentru instalare', pl: 'Uzasadnienie montażu', hr: 'Razlog za ugradnju' },
  unplannedReasonPlaceholder: { de: 'Warum war dieses Teil hier notwendig?', ro: 'De ce a fost necesară această piesă aici?', pl: 'Dlaczego ta część była tutaj potrzebna?', hr: 'Zašto je ovaj dio bio potreban ovdje?' },
  ...
  unclearRecord: { de: 'Material erfassen', ro: 'Înregistrează material', pl: 'Zarejestruj materiał', hr: 'Evidentiraj materijal' },
  unplannedRecordBtn: { de: 'Material erfassen', ro: 'Înregistrează material', pl: 'Zarejestruj materiał', hr: 'Evidentiraj materijal' },
  selectRoomMaterial: { de: 'Material aus Raum auswählen...', ro: 'Selectează material din încăpere...', pl: 'Wybierz materiał z pomieszczenia...', hr: 'Odaberi materijal iz prostorije...' },
  dropdownRoomMaterials: { de: 'Material im Raum', ro: 'Material în încăpere', pl: 'Materiał w pomieszczeniu', hr: 'Materijal u prostoriji' },
  validationFillRequired: { de: '⚠️ Bitte alle rot markierten Pflichtfelder ausfüllen', ro: '⚠️ Vă rugăm să completați toate câmpurile obligatorii marcate cu roșu', pl: '⚠️ Proszę wypełnić wszystkie wymagane pola zaznaczone na czerwono', hr: '⚠️ Molimo ispunite sva obavezna polja označena crvenom bojom' },
  ...
  overReasonLabel: { de: 'Grund für Bauleiter & Mehrbedarf wählen:', ro: 'Alege motivul pentru șeful de șantier:', pl: 'Wybierz powód dla kierownika budowy:', hr: 'Odaberi razlog za voditelja gradilišta:' },
  ...
  completeOver: { de: 'Mehrverbrauch (Mehrbedarf)', ro: 'Consum suplimentar (necesar suplimentar)', pl: 'Nadmierne zużycie (dodatkowe zapotrzebowanie)', hr: 'Dodatna potrošnja (dodatna potreba)' },
  ...
  roomLockedBanner: { de: 'Dieser Raum wurde fertiggestellt (schreibgeschützt).', ro: 'Această încăpere a fost finalizată (numai citire).', pl: 'To pomieszczenie zostało ukończone (tylko do odczytu).', hr: 'Ova prostorija je dovršena (samo za čitanje).' },
  roomLockedBannerSub: { de: 'Änderungen können nur durch den Bauleiter im Admin-Bereich freigeschaltet werden.', ro: 'Modificările pot fi deblocate doar de către șeful de șantier în panoul de administrare.', pl: 'Zmiany mogą zostać odblokowane tylko przez kierownika budowy w panelu administratora.', hr: 'Izmjene može otključati samo voditelj gradilišta u administratorskoj ploči.' },
  roomLockedAlertTitle: { de: 'Raum bereits fertiggestellt', ro: 'Încăpere deja finalizată', pl: 'Pomieszczenie już ukończone', hr: 'Prostorija je već dovršena' },
  roomLockedAlertMsg: { de: 'Dieser Raum wurde bereits fertiggestellt. Änderungen sind gesperrt und können nur durch den Bauleiter im Admin-Bereich freigeschaltet werden.', ro: 'Această încăpere a fost deja finalizată. Modificările sunt blocate și pot fi deblocate doar de către șeful de șantier în panoul de administrare.', pl: 'To pomieszczenie zostało już ukończone. Zmiany są zablokowane i mogą zostać odblokowane tylko przez kierownika w panelu administratora.', hr: 'Ova prostorija je već dovršena. Izmjene su zaključane i može ih otključati samo voditelj gradilišta u administratorskoj ploči.' },
  roomLockedCompletedBtn: { de: '✓ Raum fertiggestellt (Gesperrt)', ro: '✓ Încăpere finalizată (Blocat)', pl: '✓ Pomieszczenie ukończone (Zablokowane)', hr: '✓ Prostorija dovršena (Zaključano)' },
  ...
  maxDeliveryReachedMsg: { de: 'Für dieses Material wurden insgesamt nur {delivered} {qu} geliefert. Mehrverbrauch ist nur bis zur gelieferten Menge möglich. Weiterer Bedarf muss als Mehrbedarf angefragt werden.', ro: 'Pentru acest material s-au livrat doar {delivered} {qu} în total. Consumul suplimentar este posibil doar până la cantitatea livrată. Necesarul suplimentar trebuie solicitat ca necesar suplimentar.', pl: 'Dla tego materiału dostarczono łącznie tylko {delivered} {qu}. Nadmierne zużycie jest możliwe tylko do ilości dostarczonej. Dalsze zapotrzebowanie należy zgłosić jako dodatkowe zapotrzebowanie.', hr: 'Za ovaj materijal ukupno je isporučeno samo {delivered} {qu}. Dodatna potrošnja moguća je samo do isporučene količine. Dodatne potrebe moraju se zatražiti kao dodatna potreba.' },
  ...
  noOverPossibleMsg: { de: 'Die gelieferte Gesamtmenge ({delivered} {qu}) ist bereits voll verplant ({planned} {qu}). Zusätzlicher Bedarf muss als Mehrbedarf angefragt werden.', ro: 'Cantitatea livrată ({delivered} {qu}) este deja planificată integral ({planned} {qu}). Necesarul suplimentar trebuie solicitat ca necesar suplimentar.', pl: 'Dostarczona ilość ({delivered} {qu}) jest już w pełni zaplanowana ({planned} {qu}). Dodatkowe zapotrzebowanie należy zgłosić jako dodatkowe zapotrzebowanie.', hr: 'Isporučena količina ({delivered} {qu}) već je u potpunosti planirana ({planned} {qu}). Dodatna potreba mora se zatražiti kao dodatna potreba.' },
  ...
  // Mehrbedarf / Anfrage auf Material & Zeit
  nachtrag: { de: 'Mehrbedarf', ro: 'Necesar suplimentar', pl: 'Dodatkowe zapotrzebowanie', hr: 'Dodatna potreba' },
  nachtragTitle: { de: 'Mehrbedarf', ro: 'Necesar suplimentar', pl: 'Dodatkowe zapotrzebowanie', hr: 'Dodatna potreba' },
  nachtragSub: { de: 'Anfrage auf zusätzliches Material oder Zeit', ro: 'Cerere pentru material sau timp suplimentar', pl: 'Wniosek o dodatkowy materiał lub czas', hr: 'Zahtjev za dodatni materijal ili vrijeme' },
  mehrbedarfSaved: { de: 'Mehrbedarf wurde zur Synchronisation hinterlegt.', ro: 'Necesarul suplimentar a fost salvat pentru sincronizare.', pl: 'Dodatkowe zapotrzebowanie zostało zapisane do synchronizacji.', hr: 'Dodatna potreba je spremljena za sinkronizaciju.' },
  ...
  reCreate: { de: 'Mehrbedarf anfragen', ro: 'Solicită necesar suplimentar', pl: 'Wyślij zapotrzebowanie', hr: 'Zatraži dodatnu potrebu' },
  reCreateHours: { de: 'Mehrbedarf (Zeit) anfragen', ro: 'Solicită timp suplimentar', pl: 'Zgłoś dodatkowy czas', hr: 'Zatraži dodatno radno vrijeme' },
  ...
  fieldsComplete: { de: '✓ Alle Angaben vollständig – Mehrbedarf kann angefragt werden', ro: '✓ Toate datele sunt complete – cererea poate fi trimisă', pl: '✓ Wszystkie dane kompletne – można wysłać zapotrzebowanie', hr: '✓ Svi podaci potpuni – zahtjev se može poslati' },
  nachtragOpen: { de: 'Bereits erfasster Mehrbedarf', ro: 'Necesar suplimentar deja înregistrat', pl: 'Już zgłoszone zapotrzebowanie', hr: 'Već unesene dodatne potrebe' },
  ...
  pinWrongAttempts: { de: 'Falscher PIN. Noch {n} Versuch(e).', ro: 'PIN incorect. Mai ai {n} încercare/încercări.', pl: 'Błędny PIN. Pozostało {n} prób.', hr: 'Pogrešan PIN. Preostalo {n} pokušaja.' },
  pinLockedTitle: { de: 'Sicherheitssperre aktiv', ro: 'Blocare de securitate activă', pl: 'Blokada bezpieczeństwa', hr: 'Sigurnosno zaključavanje' },
  pinLockedMsg: { de: '3-mal falscher PIN. Das System ist für 30 Minuten gesperrt. Bitte in {mins} Minute(n) erneut versuchen.', ro: 'PIN incorect de 3 ori. Sistemul este blocat timp de 30 de minute. Reîncearcă în {mins} minut(e).', pl: '3 razy błędny PIN. System zablokowany na 30 minut. Spróbuj ponownie za {mins} min.', hr: '3 puta pogrešan PIN. Sustav je zaključan na 30 minuta. Pokušajte ponovno za {mins} min.' },
  pinLockedNotice: { de: 'System gesperrt: Noch {mins} min', ro: 'Sistem blocat: Încă {mins} min', pl: 'System zablokowany: Jeszcze {mins} min', hr: 'Sustav zaključan: Još {mins} min' },
  selectProjectTitle: { de: 'Projekt auswählen', ro: 'Selectează proiectul', pl: 'Wybierz projekt', hr: 'Odaberi projekt' },
  selectProjectSub: { de: 'Wähle die Baustelle aus, die du bearbeiten möchtest:', ro: 'Selectează șantierul pe care dorești să lucrezi:', pl: 'Wybierz budowę, na której chcesz pracować:', hr: 'Odaberi gradilište na kojem želiš raditi:' },
  loggedInAs: { de: 'Angemeldet als', ro: 'Conectat ca', pl: 'Zalogowano jako', hr: 'Prijavljen kao' },
  openProjectBtn: { de: 'Projekt öffnen ›', ro: 'Deschide proiectul ›', pl: 'Otwórz projekt ›', hr: 'Otvori projekt ›' },
  switchProject: { de: 'Projekt wechseln', ro: 'Schimbă proiectul', pl: 'Zmień projekt', hr: 'Promijeni projekt' },
  assignedProjectsCount: { de: '{n} Baustellen zugeordnet', ro: '{n} șantiere alocate', pl: 'Przypisano {n} budowy', hr: 'Dodijeljeno {n} gradilišta' },
